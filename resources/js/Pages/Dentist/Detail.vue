...
<template>
    <DefaultLayout>
        ...
        <div class="w-auto h-auto flex justify-start items-center gap-3 bg-gray-100 p-1.5 rounded-md mt-2">
        ...
        <div class="h-full p-2">
            ...
            <template v-if="currentTab === 'Schedules'">
                <p>This schedules</p>
            </template>
            ...
            <template v-if="currentTab === 'Treatment'">
                <p>This Treatment</p>
            </template>
        </div>
    </DefaultLayout>
