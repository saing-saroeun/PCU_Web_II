...
import DropdownUser from '../../Components/DefaultLayout/Header/DropdownUser.vue'
...
<template>
    <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
        <div class="flex flex-grow items-center justify-between py-2 px-3 shadow-2">
                ...
                <form >
                    <div class="relative">
                        <button class="absolute top-1/2 left-0 -translate-y-1/2">
                            <svg class=" hover:fill-primary dark:fill-bodydark dark:hover:fill-primary"
                        ...
                        <input type="text" placeholder="Type to search..."
                            class="w-full text-white xl:w-125 bg-transparent pr-4 pl-9 border-none focus:outline-none" />
                    </div>
                </form>
            </div>
